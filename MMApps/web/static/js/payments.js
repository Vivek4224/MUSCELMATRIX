...
function showCreditCard() {
  ...
  document
    .querySelector('button[onclick="showCreditCard"]')
...
function showDebitCard() {
  ...
  document
    ...
    .forEach((btn) => btn.classList.remove("active"));
  document
    .querySelector('button[onclick="showDebitCard"]')
    .classList.add("active");
...
function showNetBanking() {
  ...
  document
    ...
    .forEach((btn) => btn.classList.remove("active"));
  document
    .querySelector('button[onclick="showNetBanking"]')
    .classList.add("active");
...
function downloadReceipt() {
  if (window.jspdf) {
    ...
    yPosition += 10;
    doc.text("Amount Paid: " + selectedAmount + "INR", 20, yPosition);
    yPosition += 10;
    ...
    doc.text("Thank you for choosing MuscleMatrix Gym!", 75, yPosition, {
      align: "center",
    });
    ...
    alert(
      "PDF library is missing. Please ensure the jsPDF script is included in your HTML."
    );
  }
}
